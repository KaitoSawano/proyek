...
```bash
git clone https://github.com/xcosh-chain/go-chain.git mychain
cd mychain
```
...
# Example: changing from github.com/xcosh-chain to github.com/yourorg/mychain
OLD_MODULE="github.com/xcosh-chain"
